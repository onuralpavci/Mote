...
import com.avci.mote.modules.customview.customtextareainput.ui.CustomTextAreaInput
...
class CreateNoteTextAreaItemViewHolder(
    ...
    DraggableItemViewHolderComponent<CustomTextAreaInput> by DraggableItemViewHolderDelegate() {
